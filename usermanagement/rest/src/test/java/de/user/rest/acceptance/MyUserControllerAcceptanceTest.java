...
public class MyUserControllerAcceptanceTest extends AbstractControllerAcceptanceTest<MyUserEntity> {


    final static Logger LOG = LoggerFactory.getLogger(MyUserControllerAcceptanceTest.class);
    private static final String data = "testdata/myuser/";
    private static final String restpath = "/api/myusers/";

    private JacksonTester<MyUserEntity> jsonTester;
    ...
    @Override
    public JacksonTester<MyUserEntity> getJsonTester() {
        return jsonTester;
    }
    ...
    public void canCreate() throws Exception {
        // given
//        MyUserEntity entity = readFromFile(data + "MyUser.json");
...
//        MyUserEntity entityresult = mapper.readValue(response.getContentAsString(), MyUserEntity.class);
//        assertThat(entityresult.getBranch()).isEqualTo("v2");
    ...
    public void isValidated() throws Exception {
        // given
//        MyUserEntity entity = readFromFile(data + "MyUser-wrong.json");
...
//        MyUserEntity entity = readFromFile(data + "MyUser.json");
//        MockHttpServletResponse response = create(entity);
//        MyUserEntity entity2 = mapper.readValue(response.getContentAsString(), MyUserEntity.class);
